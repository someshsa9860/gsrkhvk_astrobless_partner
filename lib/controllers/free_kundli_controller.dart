...
import 'package:callvcal/constants/imageConst.dart';
import 'package:callvcal/controllers/kundli_matchig_controller.dart';
import 'package:callvcal/models/kundli.dart';
import 'package:callvcal/models/kundliBasicModel.dart';
import 'package:callvcal/models/kundliModel.dart';
import 'package:callvcal/models/pdfModel.dart';
...
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/dashdetailmodel.dart';
...
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/screens/GetKundliDetailScreen.dart';
          ...
          await apiHelper
            ...
            if (result.status == "true") {
              ...
              if (flagId == 1) {
                ...
                kundliMatchingController!.boy_timezone = double.parse("5.5");
                kundliMatchingController.update();
              } else if (flagId == 2) {
                // kundliMatchingController!.girl_timezone =
                //     double.parse(result.recordList['timezone'].toString());
                kundliMatchingController!.girl_timezone = double.parse("5.5");
                kundliMatchingController.update();
              } else {
                timeZone = double.parse("5.5");
              }
              update();
            } else {
