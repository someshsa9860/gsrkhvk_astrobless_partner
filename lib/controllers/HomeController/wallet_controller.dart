...
class WalletController extends GetxController {
  ...
  withdrawWalletAmount() async {
    /// here we will show dialog to user if withdraw amount is less than 1000 user can withdraw only if wallet amount is greater than 1000 then user can withdraw without any issue
