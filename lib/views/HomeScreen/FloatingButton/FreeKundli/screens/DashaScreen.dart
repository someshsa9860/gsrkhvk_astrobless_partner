...
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/screens/arrowbox.dart';
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              physics: const NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              itemCount: prayantarlist
                      ?.paryantardasha?[kundlicontroller.mahadashaSelectedIndex]
                          [kundlicontroller.kundliTabInitialIndex]
                      .length ??
                  0,
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    Row(
                      children: [
                        buildVerticalDivider(),
                        buildTableCell(prayantarlist?.paryantardasha?[
