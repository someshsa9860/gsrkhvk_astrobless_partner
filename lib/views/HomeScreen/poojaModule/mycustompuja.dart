...
import 'package:callvcal/controllers/custompujaController.dart';
import 'package:callvcal/utils/global.dart';
import 'package:callvcal/views/HomeScreen/poojaModule/AddPujaForm.dart';
import 'package:callvcal/views/HomeScreen/poojaModule/AssignPujaScreen.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<Productcontroller>(
        builder: (poojacontroller) => poojacontroller.custompoojalist == null
            ...
            : (poojacontroller.custompoojalist!.length == 0
                ? Center(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      puja.pujaStartDatetime!.isAfter(
                                                      DateTime.now()) ==
                                                  true &&
