...
import 'package:callvcal/views/HomeScreen/Profile/LiveScheduleScreen.dart';
import 'package:callvcal/views/HomeScreen/Profile/OfferDiscountsScreen.dart';
import 'package:callvcal/views/HomeScreen/Profile/widgetui.dart';
import 'package:callvcal/controllers/following_controller.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/Tabs/reportTabs/chatAvailabilityScreen.dart';
import 'package:callvcal/views/HomeScreen/Profile/ProfileDetailScreen/assignment_detail_screen.dart';
import 'package:callvcal/views/HomeScreen/Profile/ProfileDetailScreen/availabity_Detail_screen.dart';
import 'package:callvcal/views/HomeScreen/Profile/ProfileDetailScreen/other_detail_screen.dart';
import 'package:callvcal/views/HomeScreen/Profile/ProfileDetailScreen/skill_detail_screen.dart';
import 'package:callvcal/views/HomeScreen/Profile/follower_list_screen.dart';
import 'package:callvcal/views/HomeScreen/Profile/mediapickerDialog.dart';
import 'package:callvcal/views/HomeScreen/Profile/stories_screen.dart';
import 'package:callvcal/views/HomeScreen/call/agora/callAvailabilityScreen.dart';
import 'package:callvcal/views/HomeScreen/viewStories.dart';
        ...
        itemBuilder: (context, index) => _buildoptionlistwidget(
          ...
          (indexx) async {
            ...
            if (indexx == 7) {
              ...
              Get.to(() => const ChatAvailabilityScreen());
            }
            if (indexx == 8) {
              ...
              Get.to(() => const CallAvailabilityScreen());
            }
          },
        ),
      ),
