...
class _CommissionScreenState extends State<CommissionScreen> {
  ...
  void _getDiscoutedPrice() {
    ...
    commissionController.selectedChat.value =
        chatRate is String ? double.parse(chatRate).toInt() : chatRate ?? 0;
    commissionController.selectedAudio.value =
        audioRate is String ? double.parse(audioRate).toInt() : audioRate ?? 0;
    commissionController.selectedVideo.value =
        videoRate is String ? double.parse(videoRate).toInt() : videoRate ?? 0;
