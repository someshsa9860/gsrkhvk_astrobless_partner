...
ImageModel imageModelFromJson(dynamic str) =>
    ImageModel.fromJson(json.decode(str));

dynamic imageModelToJson(ImageModel data) => json.encode(data.toJson());
...
PujaImageModel pujaImageModelFromJson(dynamic str) => PujaImageModel.fromJson(json.decode(str));

dynamic pujaImageModelToJson(PujaImageModel data) => json.encode(data.toJson());
