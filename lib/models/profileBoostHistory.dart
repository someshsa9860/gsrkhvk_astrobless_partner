...
ProfileboostHistory profileboostHistoryFromJson(dynamic str) => ProfileboostHistory.fromJson(json.decode(str));

dynamic profileboostHistoryToJson(ProfileboostHistory data) => json.encode(data.toJson());
