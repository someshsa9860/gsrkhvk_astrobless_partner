...
import 'package:callvcal/models/History/call_history_model.dart';
import 'package:callvcal/models/History/chat_history_model.dart';
import 'package:callvcal/models/History/report_history_model.dart';
import 'package:callvcal/models/History/wallet_history_model.dart';
import 'package:callvcal/models/Master%20Table%20Model/all_skill_model.dart';
import 'package:callvcal/models/Master%20Table%20Model/astrologer_category_list_model.dart';
import 'package:callvcal/models/Master%20Table%20Model/language_list_model.dart';
import 'package:callvcal/models/Master%20Table%20Model/primary_skill_model.dart';
import 'package:callvcal/models/customerReview_model.dart';
import 'package:callvcal/models/systemFlagModel.dart';
import 'package:callvcal/models/week_model.dart';
...
class CurrentUser {
  ...
  dynamic isshowcallsections;
  dynamic isshowchatsections;
  dynamic isshowlivesections;
  dynamic countrycode;
  ...
  dynamic otherPlatformName;
  dynamic otherPlatformMonthlyEarning;
  dynamic onboardYou;
  dynamic suitableInterviewTime;
  dynamic currentCity;
  dynamic mainSourceOfBusiness;
  dynamic highestQualification;
  dynamic degreeDiploma;
  dynamic collegeSchoolUniversity;
  dynamic learnAstrology;
  dynamic instagramProfileLink;
  dynamic facebookProfileLink;
  dynamic linkedInProfileLink;
  dynamic youtubeProfileLink;
  dynamic webSiteProfileLink;
  dynamic referedPersonName;
  dynamic expectedMinimumEarning;
  dynamic expectedMaximumEarning;
  dynamic longBio;
  dynamic foreignCountryCount;
  dynamic currentlyWorkingJob;
  dynamic goodQualityOfAstrologer;
  dynamic biggestChallengeFaced;
  dynamic repeatedQuestion;
  List<Week>? week;
