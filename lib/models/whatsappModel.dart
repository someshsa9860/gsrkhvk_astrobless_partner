...
WhatsapplogindetailsModel whatsapplogindetailsModelFromJson(dynamic str) =>
    WhatsapplogindetailsModel.fromJson(json.decode(str));

dynamic whatsapplogindetailsModelToJson(WhatsapplogindetailsModel data) =>
