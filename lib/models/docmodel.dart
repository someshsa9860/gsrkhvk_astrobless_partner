...
DocumetModel documetModelFromJson(dynamic str) => DocumetModel.fromJson(json.decode(str));

dynamic documetModelToJson(DocumetModel data) => json.encode(data.toJson());
