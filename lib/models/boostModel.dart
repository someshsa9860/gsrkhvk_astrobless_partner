...
GetBoostModel getBoostModelFromJson(dynamic str) => GetBoostModel.fromJson(json.decode(str));

dynamic getBoostModelToJson(GetBoostModel data) => json.encode(data.toJson());
...
class BoostData {
  dynamic id;
  dynamic chatCommission;
  dynamic callCommission;
  dynamic videoCallCommission;
  List<String>? profileBoostBenefits;
  dynamic profileBoost;
  DateTime? createdAt;
  DateTime? updatedAt;
  dynamic remainingBoost;
