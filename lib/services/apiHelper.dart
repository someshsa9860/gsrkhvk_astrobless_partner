...
import 'package:callvcal/Courses/model/coursemodel.dart';
import 'package:callvcal/controllers/dailyHoroscopeController.dart';
import 'package:callvcal/models/Master%20Table%20Model/get_master_table_list_model.dart';
import 'package:callvcal/models/Notification/notification_model.dart';
import 'package:callvcal/models/Notification/storytextmodel.dart';
import 'package:callvcal/models/app_review_model.dart';
import 'package:callvcal/models/astrologerAssistant_model.dart';
import 'package:callvcal/models/astrologerTicketsModel.dart';
import 'package:callvcal/models/bankDetailsModel.dart';
import 'package:callvcal/models/boostModel.dart';
import 'package:callvcal/models/call_model.dart';
import 'package:callvcal/models/chat_model.dart';
import 'package:callvcal/models/customerReview_model.dart';
import 'package:callvcal/models/dailyHororscopeModelVedic.dart';
import 'package:callvcal/models/device_detail_model.dart';
import 'package:callvcal/models/docmodel.dart';
import 'package:callvcal/models/following_model.dart';
import 'package:callvcal/models/hororScopeSignModel.dart';
import 'package:callvcal/models/imageModel.dart';
import 'package:callvcal/models/kundliBasicModel.dart';
import 'package:callvcal/models/kundliModel.dart';
import 'package:callvcal/models/productModelScreen.dart';
import 'package:callvcal/models/product_category_list_model.dart';
import 'package:callvcal/models/product_model.dart';
import 'package:callvcal/models/profileBoostHistory.dart';
import 'package:callvcal/models/report_model.dart';
import 'package:callvcal/models/systemFlagModel.dart';
import 'package:callvcal/models/user_model.dart';
import 'package:callvcal/models/viewStoryModel.dart';
import 'package:callvcal/models/wallet_model.dart';
import 'package:callvcal/models/withdrawOptionModel.dart';
import 'package:callvcal/services/apiResult.dart';
import 'package:callvcal/utils/global.dart' as global;
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/astavargaDetailModel.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/basicDetailmodel.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/chartDetailmodel.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/doshaDetailModel.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/planetreportmodel.dart';
import 'package:callvcal/views/HomeScreen/FloatingButton/FreeKundli/model/reportModel.dart';
...
class APIHelper {
  ...
  Future<dynamic> getHoroscope({int? horoscopeSignId}) async {
    ...
    try {
      ...
      int _ncalltype =
          int.tryParse("${json.decode(response.body)['astroApiCallType']}") ??
              2;
